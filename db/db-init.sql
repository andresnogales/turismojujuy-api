...
CREATE TABLE public.articles (
	...
	CONSTRAINT article_location_fk FOREIGN KEY (location_id) REFERENCES public.locations(id)
);
...
CREATE TABLE public.article_categories (
	...
	CONSTRAINT article_fk FOREIGN KEY (article_id) REFERENCES public.articles(id) ON DELETE CASCADE,
